...
public class InversionCount {
    ...
    public static void main(String[] args) {
        ...
        // 测试1: 测试随机数组
        int[] arr = SortTestHelper.generate(N, 0, 100);
        System.out.println("Test Inversion Count for Random Array, n = " + N + " :" + solve(arr));

        // 测试2: 测试完全有序的数组
        // 结果应该为0
        arr = SortTestHelper.generateNearlyOrderly(N, 0);
        System.out.println("Test Inversion Count for Ordered Array, n = " + N + " :" + solve(arr));

        // 测试3: 测试完全逆序的数组
        // 结果应改为 N*(N-1)/2
        arr = SortTestHelper.generateInversionArray(N);
        System.out.println("Test Inversion Count for Inversion Array, n = " + N + " :" + solve(arr));
    }
}
